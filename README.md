...
- pandas 1.1.5
- SciPy 1.4.0
- Funció '_ImHausdorff_' [(Pàgina webweb per descarregar la funció)](https://es.mathworks.com/matlabcentral/fileexchange/70522-imhausdorff).
- Funció '_Make STL of 3D array_'[(Pàgina webweb per descarregar la funció)](https://es.mathworks.com/matlabcentral/fileexchange/68794-make-stl-of-3d-array-optimal-for-3d-printing?s_tid=prof_contriblnk).
